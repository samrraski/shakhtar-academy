    ...
    return (
      <div className="bg-brand-gray-900 rounded-2xl p-8 shadow-2xl text-center">
        ...
        <p className="text-brand-gray-400 text-sm">
          ...
          Confirm your email to finish creating your account, then sign in to access your portal.
        </p>
        <Link
          href="/sign-in"
  ...
  return (
    <div className="bg-brand-gray-900 rounded-2xl p-8 shadow-2xl">
      ...
      <p className="text-brand-gray-400 text-sm mb-6">
        Set up a parent account to register players and manage everything in one place.
      </p>
